...
HD_PWD='/home/dsplab/ANGLE_DISPLAY/ANGLE_DISPLAY.runs/ila_naam_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_naam.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ila_naam.tcl
