...
#
# Generated by Vivado on Wed Oct 18 17:12:25 IST 2017
...
# Script info
echo -e "sqrt.sh - Script generated by export_simulation (Vivado v2015.4 (64-bit)-id)\n"
...
if [[ ($# == 1 ) && ($1 != "-lib_map_path" && $1 != "-noclean_files" && $1 != "-reset_run" && $1 != "-help" && $1 != "-h") ]]; then
  echo -e "ERROR: Unknown option specified '$1' (type \"./sqrt.sh -help\" for more information)\n"
  exit 1
fi
...
create_lib_mappings()
{
  libs=(xbip_utils_v3_0_5 c_reg_fd_v12_0_1 xbip_dsp48_wrapper_v3_0_4 xbip_pipe_v3_0_1 xbip_dsp48_addsub_v3_0_1 xbip_addsub_v3_0_1 c_addsub_v12_0_8 xbip_bram18k_v3_0_1 mult_gen_v12_0_10 axi_utils_v2_0_1 cordic_v6_0_9 xil_defaultlib)
  file="cds.lib"
  dir="ies"
...
compile()
{
  ...
  ncvhdl -work cordic_v6_0_9 $opts_vhd \
    "$ref_dir/../../../ipstatic/cordic_v6_0_9/hdl/cordic_v6_0_vh_rfs.vhd" \
    "$ref_dir/../../../ipstatic/cordic_v6_0_9/hdl/cordic_v6_0.vhd" \

  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../angle_accel.srcs/sources_1/ip/sqrt/sim/sqrt.vhd" \
...
elaborate()
{
  ...
  libs="-libname secureip -libname xbip_utils_v3_0_5 -libname c_reg_fd_v12_0_1 -libname xbip_dsp48_wrapper_v3_0_4 -libname xbip_pipe_v3_0_1 -libname xbip_dsp48_addsub_v3_0_1 -libname xbip_addsub_v3_0_1 -libname c_addsub_v12_0_8 -libname xbip_bram18k_v3_0_1 -libname mult_gen_v12_0_10 -libname axi_utils_v2_0_1 -libname cordic_v6_0_9 -libname xil_defaultlib"
  ncelab $opts xil_defaultlib.sqrt $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.sqrt -input simulate.do
}
# Script usage
usage()
{
