...
def load_wav_file(name):
	...
	while data0:
	#	print("printing data 0 here")
#		print (len(data0))

		#print("q")  # f.getnframes()
...
def wave_batch_generator(batch_size=10,source=Source.DIRECTION_WAVES,target=Target.digits): #speaker
	...
	while True:
		...
		for wav in files:
			...
			elif target==Target.direction: labels.append(one_hot_from_item(speaker(wav), speakers))
